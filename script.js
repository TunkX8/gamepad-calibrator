...
window.addEventListener("gamepadconnected", (e) => {
  ...
  statusEl.textContent = `Conectado: ${gp.id}`;
...
window.addEventListener("gamepaddisconnected", () => {
  statusEl.textContent = "Aguardando controle...";
  currentProfile = "ps";
});
...
// ====== Aplica rótulos conforme perfil ======
...
exportBtn.addEventListener("click", () => {
  ...
  a.href = url;
  a.download = "controllerProfile.json";
  a.click();
  URL.revokeObjectURL(url);
});

// ====== Inicia loop se já houver controle ======
